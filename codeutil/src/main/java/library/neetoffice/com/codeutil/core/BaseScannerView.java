...
import library.neetoffice.com.codeutil.CameraPreview;
import library.neetoffice.com.codeutil.PreviewCallback;

/**
 * Created by Deo on 2016/3/22.
 */
public abstract class BaseScannerView extends FrameLayout implements PreviewCallback {
    ...
    public BaseScannerView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setupLayout();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public BaseScannerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
